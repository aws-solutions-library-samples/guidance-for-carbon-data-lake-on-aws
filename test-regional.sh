...
do
   ...
   cdk destroy --all --context region="$region" --context adminEmail="test@test.com" --context quicksightUsername="test@test.com" #deploys all with the optional region context variable #destroys all cdk resources in the defined region --force flag prevents the required "y" confirmation
   wait
