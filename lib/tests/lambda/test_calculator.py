...
def test_scope1():
    ...
    __test_calculator(inputKey, inputBody, [EmissionOutput("customer-carbonlake-12345", 1.0562245000000001, 1.1638125000000002e-06, 2.3276250000000004e-06, 1.0569472275625, 1.056873907375, 10.21698625, 10.2162775)])
...
def test_scope2_location_based():
    ...
    __test_calculator(inputKey, inputBody, [EmissionOutput("customer-carbonlake-12345", 0.0005436, 0.0, 4.5299999999999995e-08, 0.0005570994, 0.0005556045, 0.0012298, 0.0012265)])
...
def test_scope2_market_based_residual_mix():
    ...
    __test_calculator(inputKey, inputBody, [EmissionOutput("customer-carbonlake-12345", 0.020414174106, 0.0, 0.0, 0.020414174106, 0.020414174106, 0.045064402, 0.045064402)])

def __test_calculator(inputKey, inputBody, emissionOutputs):
